...
public class Drivetrain extends SubsystemBase {
  ...
  public DifferentialDriveWheelSpeeds getWheelSpeeds() {
    return new DifferentialDriveWheelSpeeds(nativeUnitsToDistanceMeters(m_leftMaster.getSensorCollection().getQuadratureVelocity()), nativeUnitsToDistanceMeters(m_rightMaster.getSensorCollection().getQuadratureVelocity()));
  }
  ...
  public void periodic() {
    ...
    m_odometry.update(m_nav.getRotation2d(), nativeUnitsToDistanceMeters(getLeftPos()), nativeUnitsToDistanceMeters(getRightPos()));
